...
__decorate([
    rest_1.get('/inventories/{id}/product', {
        responses: {
            '200': {
                description: 'Product belonging to Inventory',
                content: {
                    'application/json': {
                        schema: { type: 'array', items: rest_1.getModelSchemaRef(models_1.Product) },
                    },
                },
            },
        },
...
], InventoryProductController.prototype, "getProduct", null);
InventoryProductController = __decorate([
